...
public class Mathematics {
    ...
    private static final String DIVIDE_BY_ZERO_ERROR_MESSAGE = "You cannot divide by 0";
     ...
     *
     * @param value1 the first integer to be multiplied
     ...
     *
     * @param value1 the first double to be multiplied
    ...
    public int divide(int value1, int value2) {
        Assert.isTrue(value2 != 0, DIVIDE_BY_ZERO_ERROR_MESSAGE);
        return value1 / value2;
    }
    ...
    public int divide(int value1, int value2, int value3) {
        Assert.isTrue(value2 != 0 && value3 != 0, DIVIDE_BY_ZERO_ERROR_MESSAGE);
        return value1 / value2 / value3;
    }
    ...
    public double squareRoot(double value) {
        Assert.isTrue(value >= 0, "You cannot find the square root of a negative number");
