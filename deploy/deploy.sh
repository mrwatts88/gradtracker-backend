...
ssh ubuntu@$DEPLOY_SERVER 'bash -s' < ./deploy/dockerImageUpdateAndStart.sh $CI_PROJECT_PATH $CI_PROJECT_PATH_SLUG $CI_COMMIT_SHA $DOCKER_REPO_USER $DOCKER_REPO_PASS
